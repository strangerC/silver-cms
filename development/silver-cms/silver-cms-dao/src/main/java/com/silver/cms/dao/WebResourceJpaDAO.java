...
import com.silver.cms.dao.exceptions.NonexistentEntityException;
 ...
 * @author liaojian
 */
public class WebResourceJpaDAO implements Serializable {
    
    public WebResourceJpaDAO() {
        this(null, Persistence.createEntityManagerFactory("silverCMSPU"));
    }
    
    public WebResourceJpaDAO(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(WebResource webResource) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findWebResource(webResource.getId()) != null) {
                throw new PreexistingEntityException("WebResource " + webResource + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
